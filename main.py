...
Дай естественный и связный немецкий вариант всего ответа ученика. Сохрани все переданные им мысли, факты, вопросы, числа и период времени. Используй целевую конструкцию урока. Можно восстановить заглавные буквы и пунктуацию. Не добавляй новой информации.

5. «А теперь повторите»

Дай только одно немецкое предложение с целевой конструкцией урока, которое ученик должен повторить. Если в естественном варианте несколько предложений, выбери предложение с целевой конструкцией. Никогда не проси повторять русское объяснение.
