...
Если ошибка именно в том, что с seit для продолжающейся ситуации использовано прошедшее время вместо Präsens, верни в feedback дословно следующую строку:
Почти правильно, но для выражения длительности нужно использовать Präsens с seit: «Ich lebe seit drei Monaten in Deutschland». Пожалуйста, запишите ответ ещё раз, исправив эту часть.
